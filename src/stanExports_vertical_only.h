...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_vertical_only");
    ...
    reader.add_event(141, 2, "restart", "model_vertical_only");
    reader.add_event(143, 4, "include", "include/data_start.stan");
    reader.add_event(143, 0, "start", "include/data_start.stan");
    reader.add_event(160, 17, "end", "include/data_start.stan");
    reader.add_event(160, 5, "restart", "model_vertical_only");
    reader.add_event(160, 5, "include", "include/data_deviation_start.stan");
    reader.add_event(160, 0, "start", "include/data_deviation_start.stan");
    reader.add_event(173, 13, "end", "include/data_deviation_start.stan");
    reader.add_event(173, 6, "restart", "model_vertical_only");
    reader.add_event(184, 17, "include", "include/transformed_data.stan");
    reader.add_event(184, 0, "start", "include/transformed_data.stan");
    reader.add_event(184, 0, "include", "include/transformed_data_declarations.stan");
    reader.add_event(184, 0, "start", "include/transformed_data_declarations.stan");
    reader.add_event(188, 4, "end", "include/transformed_data_declarations.stan");
    reader.add_event(188, 1, "restart", "include/transformed_data.stan");
    reader.add_event(195, 8, "include", "include/transformed_data_statements.stan");
    reader.add_event(195, 0, "start", "include/transformed_data_statements.stan");
    reader.add_event(196, 1, "end", "include/transformed_data_statements.stan");
    reader.add_event(196, 9, "restart", "include/transformed_data.stan");
    reader.add_event(221, 34, "end", "include/transformed_data.stan");
    reader.add_event(221, 18, "restart", "model_vertical_only");
    reader.add_event(223, 20, "include", "include/parameters_start.stan");
    reader.add_event(223, 0, "start", "include/parameters_start.stan");
    reader.add_event(227, 4, "end", "include/parameters_start.stan");
    reader.add_event(227, 21, "restart", "model_vertical_only");
    reader.add_event(227, 21, "include", "include/parameters_deviation_start.stan");
    reader.add_event(227, 0, "start", "include/parameters_deviation_start.stan");
    reader.add_event(232, 5, "end", "include/parameters_deviation_start.stan");
    reader.add_event(232, 22, "restart", "model_vertical_only");
    reader.add_event(235, 25, "include", "include/transformed_parameters_outer_start.stan");
    reader.add_event(235, 0, "start", "include/transformed_parameters_outer_start.stan");
    reader.add_event(237, 2, "end", "include/transformed_parameters_outer_start.stan");
    reader.add_event(237, 26, "restart", "model_vertical_only");
    reader.add_event(241, 30, "include", "include/transformed_parameters_inner_start.stan");
    reader.add_event(241, 0, "start", "include/transformed_parameters_inner_start.stan");
    reader.add_event(252, 11, "end", "include/transformed_parameters_inner_start.stan");
    reader.add_event(252, 31, "restart", "model_vertical_only");
    reader.add_event(252, 31, "include", "include/transformed_parameters_inner_deviation_start.stan");
    reader.add_event(252, 0, "start", "include/transformed_parameters_inner_deviation_start.stan");
    reader.add_event(269, 17, "end", "include/transformed_parameters_inner_deviation_start.stan");
    reader.add_event(269, 32, "restart", "model_vertical_only");
    reader.add_event(275, 38, "include", "include/transformed_parameters_inner_deviation_block_start.stan");
    reader.add_event(275, 0, "start", "include/transformed_parameters_inner_deviation_block_start.stan");
    reader.add_event(281, 6, "end", "include/transformed_parameters_inner_deviation_block_start.stan");
    reader.add_event(281, 39, "restart", "model_vertical_only");
    reader.add_event(288, 46, "include", "include/transformed_parameters_inner_deviation_block_end.stan");
    reader.add_event(288, 0, "start", "include/transformed_parameters_inner_deviation_block_end.stan");
    reader.add_event(339, 51, "end", "include/transformed_parameters_inner_deviation_block_end.stan");
    reader.add_event(339, 47, "restart", "model_vertical_only");
    reader.add_event(341, 49, "include", "include/transformed_parameters_inner_end.stan");
    reader.add_event(341, 0, "start", "include/transformed_parameters_inner_end.stan");
    reader.add_event(368, 27, "end", "include/transformed_parameters_inner_end.stan");
    reader.add_event(368, 50, "restart", "model_vertical_only");
    reader.add_event(371, 53, "include", "include/model_start.stan");
    reader.add_event(371, 0, "start", "include/model_start.stan");
    reader.add_event(384, 13, "end", "include/model_start.stan");
    reader.add_event(384, 54, "restart", "model_vertical_only");
    reader.add_event(384, 54, "include", "include/model_deviation_start.stan");
    reader.add_event(384, 0, "start", "include/model_deviation_start.stan");
    reader.add_event(433, 49, "end", "include/model_deviation_start.stan");
    reader.add_event(433, 55, "restart", "model_vertical_only");
    reader.add_event(439, 61, "include", "include/generated_quantities.stan");
    reader.add_event(439, 0, "start", "include/generated_quantities.stan");
    reader.add_event(443, 4, "end", "include/generated_quantities.stan");
    reader.add_event(443, 62, "restart", "model_vertical_only");
    reader.add_event(446, 63, "end", "model_vertical_only");
    return reader;
}
...
class model_vertical_only
  : public stan::model::model_base_crtp<model_vertical_only> {
private:
        int N;
        int D;
...
typedef model_vertical_only_namespace::model_vertical_only stan_model;
#ifndef USING_R
