...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_full");
    ...
    reader.add_event(141, 2, "restart", "model_full");
    ...
    reader.add_event(160, 5, "restart", "model_full");
    ...
    reader.add_event(173, 6, "restart", "model_full");
    reader.add_event(186, 19, "include", "include/transformed_data.stan");
    reader.add_event(186, 0, "start", "include/transformed_data.stan");
    ...
    reader.add_event(190, 1, "restart", "include/transformed_data.stan");
    ...
    reader.add_event(198, 9, "restart", "include/transformed_data.stan");
    reader.add_event(223, 34, "end", "include/transformed_data.stan");
    reader.add_event(223, 20, "restart", "model_full");
    reader.add_event(225, 22, "include", "include/parameters_start.stan");
    reader.add_event(225, 0, "start", "include/parameters_start.stan");
    reader.add_event(229, 4, "end", "include/parameters_start.stan");
    reader.add_event(229, 23, "restart", "model_full");
    reader.add_event(229, 23, "include", "include/parameters_deviation_start.stan");
    ...
    reader.add_event(234, 24, "restart", "model_full");
    reader.add_event(239, 29, "include", "include/transformed_parameters_outer_start.stan");
    ...
    reader.add_event(241, 30, "restart", "model_full");
    reader.add_event(245, 34, "include", "include/transformed_parameters_inner_start.stan");
    ...
    reader.add_event(256, 35, "restart", "model_full");
    reader.add_event(256, 35, "include", "include/transformed_parameters_inner_deviation_start.stan");
    reader.add_event(256, 0, "start", "include/transformed_parameters_inner_deviation_start.stan");
    reader.add_event(273, 17, "end", "include/transformed_parameters_inner_deviation_start.stan");
    reader.add_event(273, 36, "restart", "model_full");
    reader.add_event(285, 48, "include", "include/transformed_parameters_inner_deviation_block_start.stan");
    reader.add_event(285, 0, "start", "include/transformed_parameters_inner_deviation_block_start.stan");
    reader.add_event(291, 6, "end", "include/transformed_parameters_inner_deviation_block_start.stan");
    reader.add_event(291, 49, "restart", "model_full");
    reader.add_event(298, 56, "include", "include/transformed_parameters_inner_deviation_block_end.stan");
    reader.add_event(298, 0, "start", "include/transformed_parameters_inner_deviation_block_end.stan");
    reader.add_event(349, 51, "end", "include/transformed_parameters_inner_deviation_block_end.stan");
    reader.add_event(349, 57, "restart", "model_full");
    reader.add_event(351, 59, "include", "include/transformed_parameters_inner_end.stan");
    reader.add_event(351, 0, "start", "include/transformed_parameters_inner_end.stan");
    reader.add_event(378, 27, "end", "include/transformed_parameters_inner_end.stan");
    reader.add_event(378, 60, "restart", "model_full");
    reader.add_event(381, 63, "include", "include/model_start.stan");
    reader.add_event(381, 0, "start", "include/model_start.stan");
    reader.add_event(394, 13, "end", "include/model_start.stan");
    reader.add_event(394, 64, "restart", "model_full");
    reader.add_event(394, 64, "include", "include/model_deviation_start.stan");
    reader.add_event(394, 0, "start", "include/model_deviation_start.stan");
    reader.add_event(443, 49, "end", "include/model_deviation_start.stan");
    reader.add_event(443, 65, "restart", "model_full");
    reader.add_event(457, 79, "include", "include/generated_quantities.stan");
    reader.add_event(457, 0, "start", "include/generated_quantities.stan");
    reader.add_event(461, 4, "end", "include/generated_quantities.stan");
    reader.add_event(461, 80, "restart", "model_full");
    reader.add_event(464, 81, "end", "model_full");
    return reader;
}
...
class model_full
  : public stan::model::model_base_crtp<model_full> {
private:
        int N;
        int D;
...
public:
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        try {
            ...
            context__.validate_dims("data initialization", "D_rotation", "int", context__.to_vec());
            D_rotation = int(0);
            vals_i__ = context__.vals_i("D_rotation");
            pos__ = 0;
            D_rotation = vals_i__[pos__++];
            check_greater_or_equal(function__, "D_rotation", D_rotation, 0);
            ...
            validate_non_negative_index("L_deviation", "D_rotation", D_rotation);
            validate_non_negative_index("L_deviation", "D_rotation", D_rotation);
            num_params_r__ += ((D_rotation * (D_rotation - 1)) / 2);
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
            throw std::runtime_error("*** IF YOU SEE THIS, PLEASE REPORT A BUG ***");
    ...
    void transform_inits(const stan::io::var_context& context__,
        ...
        validate_non_negative_index("L_deviation", "D_rotation", D_rotation);
        validate_non_negative_index("L_deviation", "D_rotation", D_rotation);
        context__.validate_dims("parameter initialization", "L_deviation", "matrix_d", context__.to_vec(D_rotation,D_rotation));
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> L_deviation(D_rotation, D_rotation);
        size_t L_deviation_j_2_max__ = D_rotation;
        size_t L_deviation_j_1_max__ = D_rotation;
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            if (jacobian__)
                L_deviation = in__.cholesky_factor_corr_constrain(D_rotation, lp__);
            else
                L_deviation = in__.cholesky_factor_corr_constrain(D_rotation);
            ...
            for (int i = 1; i <= N; ++i) {
                ...
                if (as_bool(logical_gt(D_rotation, 0))) {
    ...
    void write_array(RNG& base_rng__,
        ...
        Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> L_deviation = in__.cholesky_factor_corr_constrain(D_rotation);
        size_t L_deviation_j_2_max__ = D_rotation;
        size_t L_deviation_j_1_max__ = D_rotation;
        for (size_t j_2__ = 0; j_2__ < L_deviation_j_2_max__; ++j_2__) {
            for (size_t j_1__ = 0; j_1__ < L_deviation_j_1_max__; ++j_1__) {
    ...
    void unconstrained_param_names(std::vector<std::string>& param_names__,
        ...
        size_t L_deviation_j_1_max__ = ((D_rotation * (D_rotation - 1)) / 2);
        for (size_t j_1__ = 0; j_1__ < L_deviation_j_1_max__; ++j_1__) {
            param_name_stream__.str(std::string());
...
typedef model_full_namespace::model_full stan_model;
#ifndef USING_R
