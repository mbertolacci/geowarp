...
namespace model_vertical_only_vecchia_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_vertical_only_vecchia");
    ...
    reader.add_event(141, 2, "restart", "model_vertical_only_vecchia");
    ...
    reader.add_event(161, 5, "restart", "model_vertical_only_vecchia");
    ...
    reader.add_event(174, 6, "restart", "model_vertical_only_vecchia");
    reader.add_event(185, 17, "include", "include/transformed_data_vecchia.stan");
    reader.add_event(185, 0, "start", "include/transformed_data_vecchia.stan");
    reader.add_event(185, 0, "include", "include/transformed_data_declarations.stan");
    reader.add_event(185, 0, "start", "include/transformed_data_declarations.stan");
    reader.add_event(189, 4, "end", "include/transformed_data_declarations.stan");
    reader.add_event(189, 1, "restart", "include/transformed_data_vecchia.stan");
    reader.add_event(196, 8, "include", "include/transformed_data_statements.stan");
    reader.add_event(196, 0, "start", "include/transformed_data_statements.stan");
    reader.add_event(197, 1, "end", "include/transformed_data_statements.stan");
    reader.add_event(197, 9, "restart", "include/transformed_data_vecchia.stan");
    reader.add_event(222, 34, "end", "include/transformed_data_vecchia.stan");
    reader.add_event(222, 18, "restart", "model_vertical_only_vecchia");
    reader.add_event(224, 20, "include", "include/parameters_start.stan");
    reader.add_event(224, 0, "start", "include/parameters_start.stan");
    reader.add_event(228, 4, "end", "include/parameters_start.stan");
    reader.add_event(228, 21, "restart", "model_vertical_only_vecchia");
    reader.add_event(228, 21, "include", "include/parameters_deviation_start.stan");
    reader.add_event(228, 0, "start", "include/parameters_deviation_start.stan");
    reader.add_event(233, 5, "end", "include/parameters_deviation_start.stan");
    reader.add_event(233, 22, "restart", "model_vertical_only_vecchia");
    reader.add_event(236, 25, "include", "include/transformed_parameters_outer_start.stan");
    reader.add_event(236, 0, "start", "include/transformed_parameters_outer_start.stan");
    reader.add_event(238, 2, "end", "include/transformed_parameters_outer_start.stan");
    reader.add_event(238, 26, "restart", "model_vertical_only_vecchia");
    reader.add_event(242, 30, "include", "include/transformed_parameters_inner_start.stan");
    reader.add_event(242, 0, "start", "include/transformed_parameters_inner_start.stan");
    reader.add_event(253, 11, "end", "include/transformed_parameters_inner_start.stan");
    reader.add_event(253, 31, "restart", "model_vertical_only_vecchia");
    reader.add_event(253, 31, "include", "include/transformed_parameters_inner_deviation_vecchia_start.stan");
    reader.add_event(253, 0, "start", "include/transformed_parameters_inner_deviation_vecchia_start.stan");
    reader.add_event(270, 17, "end", "include/transformed_parameters_inner_deviation_vecchia_start.stan");
    reader.add_event(270, 32, "restart", "model_vertical_only_vecchia");
    reader.add_event(276, 38, "include", "include/transformed_parameters_inner_deviation_vecchia_block_start.stan");
    reader.add_event(276, 0, "start", "include/transformed_parameters_inner_deviation_vecchia_block_start.stan");
    reader.add_event(282, 6, "end", "include/transformed_parameters_inner_deviation_vecchia_block_start.stan");
    reader.add_event(282, 39, "restart", "model_vertical_only_vecchia");
    reader.add_event(289, 46, "include", "include/transformed_parameters_inner_deviation_vecchia_block_end.stan");
    reader.add_event(289, 0, "start", "include/transformed_parameters_inner_deviation_vecchia_block_end.stan");
    reader.add_event(340, 51, "end", "include/transformed_parameters_inner_deviation_vecchia_block_end.stan");
    reader.add_event(340, 47, "restart", "model_vertical_only_vecchia");
    reader.add_event(342, 49, "include", "include/transformed_parameters_inner_end.stan");
    reader.add_event(342, 0, "start", "include/transformed_parameters_inner_end.stan");
    reader.add_event(369, 27, "end", "include/transformed_parameters_inner_end.stan");
    reader.add_event(369, 50, "restart", "model_vertical_only_vecchia");
    reader.add_event(372, 53, "include", "include/model_start.stan");
    reader.add_event(372, 0, "start", "include/model_start.stan");
    reader.add_event(386, 14, "end", "include/model_start.stan");
    reader.add_event(386, 54, "restart", "model_vertical_only_vecchia");
    reader.add_event(386, 54, "include", "include/model_deviation_start.stan");
    reader.add_event(386, 0, "start", "include/model_deviation_start.stan");
    reader.add_event(435, 49, "end", "include/model_deviation_start.stan");
    reader.add_event(435, 55, "restart", "model_vertical_only_vecchia");
    reader.add_event(441, 61, "include", "include/generated_quantities.stan");
    reader.add_event(441, 0, "start", "include/generated_quantities.stan");
    reader.add_event(445, 4, "end", "include/generated_quantities.stan");
    reader.add_event(445, 62, "restart", "model_vertical_only_vecchia");
    reader.add_event(448, 63, "end", "model_vertical_only_vecchia");
    return reader;
}
...
class model_vertical_only_vecchia
  : public stan::model::model_base_crtp<model_vertical_only_vecchia> {
private:
        int N;
        int D;
...
public:
    model_vertical_only_vecchia(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_vertical_only_vecchia_namespace::model_vertical_only_vecchia";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_vertical_only_vecchia_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_vertical_only_vecchia";
    }
...
typedef model_vertical_only_vecchia_namespace::model_vertical_only_vecchia stan_model;
#ifndef USING_R
