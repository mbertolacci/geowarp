...
namespace model_vertical_only_exact_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_vertical_only_exact");
    ...
    reader.add_event(141, 2, "restart", "model_vertical_only_exact");
    ...
    reader.add_event(161, 5, "restart", "model_vertical_only_exact");
    ...
    reader.add_event(174, 6, "restart", "model_vertical_only_exact");
    reader.add_event(182, 14, "include", "include/transformed_data_exact.stan");
    reader.add_event(182, 0, "start", "include/transformed_data_exact.stan");
    reader.add_event(182, 0, "include", "include/transformed_data_declarations.stan");
    reader.add_event(182, 0, "start", "include/transformed_data_declarations.stan");
    reader.add_event(186, 4, "end", "include/transformed_data_declarations.stan");
    reader.add_event(186, 1, "restart", "include/transformed_data_exact.stan");
    reader.add_event(186, 1, "include", "include/transformed_data_statements.stan");
    reader.add_event(186, 0, "start", "include/transformed_data_statements.stan");
    reader.add_event(187, 1, "end", "include/transformed_data_statements.stan");
    reader.add_event(187, 2, "restart", "include/transformed_data_exact.stan");
    reader.add_event(187, 2, "end", "include/transformed_data_exact.stan");
    reader.add_event(187, 15, "restart", "model_vertical_only_exact");
    reader.add_event(189, 17, "include", "include/parameters_start.stan");
    reader.add_event(189, 0, "start", "include/parameters_start.stan");
    reader.add_event(193, 4, "end", "include/parameters_start.stan");
    reader.add_event(193, 18, "restart", "model_vertical_only_exact");
    reader.add_event(193, 18, "include", "include/parameters_deviation_start.stan");
    reader.add_event(193, 0, "start", "include/parameters_deviation_start.stan");
    reader.add_event(198, 5, "end", "include/parameters_deviation_start.stan");
    reader.add_event(198, 19, "restart", "model_vertical_only_exact");
    ...
    reader.add_event(203, 23, "restart", "model_vertical_only_exact");
    ...
    reader.add_event(218, 28, "restart", "model_vertical_only_exact");
    ...
    reader.add_event(230, 29, "restart", "model_vertical_only_exact");
    reader.add_event(252, 51, "include", "include/transformed_parameters_inner_deviation_exact_end.stan");
    reader.add_event(252, 0, "start", "include/transformed_parameters_inner_deviation_exact_end.stan");
    reader.add_event(267, 15, "end", "include/transformed_parameters_inner_deviation_exact_end.stan");
    reader.add_event(267, 52, "restart", "model_vertical_only_exact");
    reader.add_event(267, 52, "include", "include/transformed_parameters_inner_end.stan");
    reader.add_event(267, 0, "start", "include/transformed_parameters_inner_end.stan");
    reader.add_event(294, 27, "end", "include/transformed_parameters_inner_end.stan");
    reader.add_event(294, 53, "restart", "model_vertical_only_exact");
    reader.add_event(297, 56, "include", "include/model_start.stan");
    reader.add_event(297, 0, "start", "include/model_start.stan");
    reader.add_event(311, 14, "end", "include/model_start.stan");
    reader.add_event(311, 57, "restart", "model_vertical_only_exact");
    reader.add_event(311, 57, "include", "include/model_deviation_start.stan");
    reader.add_event(311, 0, "start", "include/model_deviation_start.stan");
    reader.add_event(360, 49, "end", "include/model_deviation_start.stan");
    reader.add_event(360, 58, "restart", "model_vertical_only_exact");
    reader.add_event(366, 64, "include", "include/generated_quantities.stan");
    reader.add_event(366, 0, "start", "include/generated_quantities.stan");
    reader.add_event(370, 4, "end", "include/generated_quantities.stan");
    reader.add_event(370, 65, "restart", "model_vertical_only_exact");
    reader.add_event(373, 66, "end", "model_vertical_only_exact");
    return reader;
}
...
class model_vertical_only_exact
  : public stan::model::model_base_crtp<model_vertical_only_exact> {
private:
        int N;
        int D;
        ...
        vector_d y_tilde;
public:
    model_vertical_only_exact(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_vertical_only_exact_namespace::model_vertical_only_exact";
        ...
        try {
            ...
            context__.validate_dims("data initialization", "N_individuals", "int", context__.to_vec());
            N_individuals = int(0);
            vals_i__ = context__.vals_i("N_individuals");
            pos__ = 0;
            N_individuals = vals_i__[pos__++];
            check_greater_or_equal(function__, "N_individuals", N_individuals, 1);
            current_statement_begin__ = 177;
            validate_non_negative_index("start", "N_individuals", N_individuals);
            context__.validate_dims("data initialization", "start", "int", context__.to_vec(N_individuals));
            start = std::vector<int>(N_individuals, int(0));
            vals_i__ = context__.vals_i("start");
            pos__ = 0;
            size_t start_k_0_max__ = N_individuals;
            for (size_t k_0__ = 0; k_0__ < start_k_0_max__; ++k_0__) {
                start[k_0__] = vals_i__[pos__++];
            }
            current_statement_begin__ = 179;
            context__.validate_dims("data initialization", "gamma_deviation_a", "double", context__.to_vec());
            gamma_deviation_a = double(0);
            vals_r__ = context__.vals_r("gamma_deviation_a");
            pos__ = 0;
            gamma_deviation_a = vals_r__[pos__++];
            check_greater_or_equal(function__, "gamma_deviation_a", gamma_deviation_a, 0);
            current_statement_begin__ = 180;
            context__.validate_dims("data initialization", "gamma_deviation_b", "double", context__.to_vec());
            gamma_deviation_b = double(0);
            vals_r__ = context__.vals_r("gamma_deviation_b");
            pos__ = 0;
            gamma_deviation_b = vals_r__[pos__++];
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            std::vector<local_scalar_t__  > x_vertical_warped(N, local_scalar_t__(DUMMY_VAR__));
            stan::math::initialize(x_vertical_warped, DUMMY_VAR__);
            stan::math::fill(x_vertical_warped, DUMMY_VAR__);
            ...
            for (int i = 1; i <= N_individuals; ++i) {
                ...
                if (as_bool(logical_eq(i, N_individuals))) {
                    current_statement_begin__ = 239;
                    stan::math::assign(end, N);
                } else {
                    current_statement_begin__ = 241;
                    stan::math::assign(end, (get_base1(start, (i + 1), "start", 1) - 1));
                }
                current_statement_begin__ = 243;
                stan::model::assign(K, 
                            stan::model::cons_list(stan::model::index_min_max(get_base1(start, i, "start", 1), end), stan::model::cons_list(stan::model::index_min_max(get_base1(start, i, "start", 1), end), stan::model::nil_index_list())), 
                            exponential_cov_heteroskedastic_scalar(stan::model::rvalue(x_vertical_warped, stan::model::cons_list(stan::model::index_min_max(get_base1(start, i, "start", 1), end), stan::model::nil_index_list()), "x_vertical_warped"), stan::model::rvalue(deviation_sd, stan::model::cons_list(stan::model::index_min_max(get_base1(start, i, "start", 1), end), stan::model::nil_index_list()), "deviation_sd"), sigma_squared_nugget, pstream__), 
            ...
            if (as_bool(logical_gt(gamma_deviation_b, 0))) {
                current_statement_begin__ = 363;
                lp_accum__.add(gamma_log<propto__>(gamma_deviation_vertical, gamma_deviation_a, gamma_deviation_b));
            }
        } catch (const std::exception& e) {
            stan::lang::rethrow_located(e, current_statement_begin__, prog_reader__());
            // Next line prevents compiler griping about no return
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_vertical_only_exact_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_vertical_only_exact";
    }
...
typedef model_vertical_only_exact_namespace::model_vertical_only_exact stan_model;
#ifndef USING_R
