...
#include "stanExports_isotropic_vecchia.h"

RCPP_MODULE(stan_fit4isotropic_vecchia_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_isotropic_vecchia")
