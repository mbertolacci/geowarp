...
namespace model_isotropic_exact_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_isotropic_exact");
    ...
    reader.add_event(141, 2, "restart", "model_isotropic_exact");
    ...
    reader.add_event(161, 5, "restart", "model_isotropic_exact");
    ...
    reader.add_event(174, 6, "restart", "model_isotropic_exact");
    reader.add_event(179, 11, "include", "include/transformed_data_exact.stan");
    reader.add_event(179, 0, "start", "include/transformed_data_exact.stan");
    ...
    reader.add_event(183, 1, "restart", "include/transformed_data_exact.stan");
    reader.add_event(183, 1, "include", "include/transformed_data_statements.stan");
    reader.add_event(183, 0, "start", "include/transformed_data_statements.stan");
    reader.add_event(184, 1, "end", "include/transformed_data_statements.stan");
    reader.add_event(184, 2, "restart", "include/transformed_data_exact.stan");
    reader.add_event(184, 2, "end", "include/transformed_data_exact.stan");
    reader.add_event(184, 12, "restart", "model_isotropic_exact");
    reader.add_event(186, 14, "include", "include/parameters_start.stan");
    reader.add_event(186, 0, "start", "include/parameters_start.stan");
    reader.add_event(190, 4, "end", "include/parameters_start.stan");
    reader.add_event(190, 15, "restart", "model_isotropic_exact");
    reader.add_event(190, 15, "include", "include/parameters_deviation_start.stan");
    reader.add_event(190, 0, "start", "include/parameters_deviation_start.stan");
    reader.add_event(195, 5, "end", "include/parameters_deviation_start.stan");
    reader.add_event(195, 16, "restart", "model_isotropic_exact");
    reader.add_event(199, 20, "include", "include/transformed_parameters_outer_start.stan");
    reader.add_event(199, 0, "start", "include/transformed_parameters_outer_start.stan");
    reader.add_event(201, 2, "end", "include/transformed_parameters_outer_start.stan");
    reader.add_event(201, 21, "restart", "model_isotropic_exact");
    reader.add_event(205, 25, "include", "include/transformed_parameters_inner_start.stan");
    reader.add_event(205, 0, "start", "include/transformed_parameters_inner_start.stan");
    reader.add_event(216, 11, "end", "include/transformed_parameters_inner_start.stan");
    reader.add_event(216, 26, "restart", "model_isotropic_exact");
    reader.add_event(216, 26, "include", "include/transformed_parameters_inner_deviation_exact_start.stan");
    reader.add_event(216, 0, "start", "include/transformed_parameters_inner_deviation_exact_start.stan");
    reader.add_event(228, 12, "end", "include/transformed_parameters_inner_deviation_exact_start.stan");
    reader.add_event(228, 27, "restart", "model_isotropic_exact");
    reader.add_event(242, 41, "include", "include/transformed_parameters_inner_deviation_exact_end.stan");
    reader.add_event(242, 0, "start", "include/transformed_parameters_inner_deviation_exact_end.stan");
    reader.add_event(257, 15, "end", "include/transformed_parameters_inner_deviation_exact_end.stan");
    reader.add_event(257, 42, "restart", "model_isotropic_exact");
    reader.add_event(257, 42, "include", "include/transformed_parameters_inner_end.stan");
    reader.add_event(257, 0, "start", "include/transformed_parameters_inner_end.stan");
    reader.add_event(284, 27, "end", "include/transformed_parameters_inner_end.stan");
    reader.add_event(284, 43, "restart", "model_isotropic_exact");
    reader.add_event(287, 46, "include", "include/model_start.stan");
    reader.add_event(287, 0, "start", "include/model_start.stan");
    reader.add_event(301, 14, "end", "include/model_start.stan");
    reader.add_event(301, 47, "restart", "model_isotropic_exact");
    reader.add_event(301, 47, "include", "include/model_deviation_start.stan");
    reader.add_event(301, 0, "start", "include/model_deviation_start.stan");
    reader.add_event(350, 49, "end", "include/model_deviation_start.stan");
    reader.add_event(350, 48, "restart", "model_isotropic_exact");
    reader.add_event(361, 59, "include", "include/generated_quantities.stan");
    reader.add_event(361, 0, "start", "include/generated_quantities.stan");
    reader.add_event(365, 4, "end", "include/generated_quantities.stan");
    reader.add_event(365, 60, "restart", "model_isotropic_exact");
    reader.add_event(368, 61, "end", "model_isotropic_exact");
    return reader;
}
...
class model_isotropic_exact
  : public stan::model::model_base_crtp<model_isotropic_exact> {
private:
        int N;
        int D;
        ...
        vector_d y_tilde;
public:
    model_isotropic_exact(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_isotropic_exact_namespace::model_isotropic_exact";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_isotropic_exact_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_isotropic_exact_namespace::model_isotropic_exact stan_model;
#ifndef USING_R
