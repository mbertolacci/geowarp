...
#include "stanExports_vertical_only_exact.h"

RCPP_MODULE(stan_fit4vertical_only_exact_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_vertical_only_exact")
