...
namespace model_isotropic_vecchia_namespace {
using std::istream;
using std::string;
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_isotropic_vecchia");
    ...
    reader.add_event(141, 2, "restart", "model_isotropic_vecchia");
    ...
    reader.add_event(161, 5, "restart", "model_isotropic_vecchia");
    ...
    reader.add_event(174, 6, "restart", "model_isotropic_vecchia");
    ...
    reader.add_event(222, 18, "restart", "model_isotropic_vecchia");
    ...
    reader.add_event(228, 21, "restart", "model_isotropic_vecchia");
    ...
    reader.add_event(233, 22, "restart", "model_isotropic_vecchia");
    reader.add_event(237, 26, "include", "include/transformed_parameters_outer_start.stan");
    reader.add_event(237, 0, "start", "include/transformed_parameters_outer_start.stan");
    reader.add_event(239, 2, "end", "include/transformed_parameters_outer_start.stan");
    reader.add_event(239, 27, "restart", "model_isotropic_vecchia");
    reader.add_event(243, 31, "include", "include/transformed_parameters_inner_start.stan");
    reader.add_event(243, 0, "start", "include/transformed_parameters_inner_start.stan");
    reader.add_event(254, 11, "end", "include/transformed_parameters_inner_start.stan");
    reader.add_event(254, 32, "restart", "model_isotropic_vecchia");
    reader.add_event(254, 32, "include", "include/transformed_parameters_inner_deviation_vecchia_start.stan");
    reader.add_event(254, 0, "start", "include/transformed_parameters_inner_deviation_vecchia_start.stan");
    reader.add_event(271, 17, "end", "include/transformed_parameters_inner_deviation_vecchia_start.stan");
    reader.add_event(271, 33, "restart", "model_isotropic_vecchia");
    reader.add_event(280, 42, "include", "include/transformed_parameters_inner_deviation_vecchia_block_start.stan");
    reader.add_event(280, 0, "start", "include/transformed_parameters_inner_deviation_vecchia_block_start.stan");
    reader.add_event(286, 6, "end", "include/transformed_parameters_inner_deviation_vecchia_block_start.stan");
    reader.add_event(286, 43, "restart", "model_isotropic_vecchia");
    reader.add_event(293, 50, "include", "include/transformed_parameters_inner_deviation_vecchia_block_end.stan");
    reader.add_event(293, 0, "start", "include/transformed_parameters_inner_deviation_vecchia_block_end.stan");
    reader.add_event(344, 51, "end", "include/transformed_parameters_inner_deviation_vecchia_block_end.stan");
    reader.add_event(344, 51, "restart", "model_isotropic_vecchia");
    reader.add_event(346, 53, "include", "include/transformed_parameters_inner_end.stan");
    reader.add_event(346, 0, "start", "include/transformed_parameters_inner_end.stan");
    reader.add_event(373, 27, "end", "include/transformed_parameters_inner_end.stan");
    reader.add_event(373, 54, "restart", "model_isotropic_vecchia");
    reader.add_event(376, 57, "include", "include/model_start.stan");
    reader.add_event(376, 0, "start", "include/model_start.stan");
    reader.add_event(390, 14, "end", "include/model_start.stan");
    reader.add_event(390, 58, "restart", "model_isotropic_vecchia");
    reader.add_event(390, 58, "include", "include/model_deviation_start.stan");
    reader.add_event(390, 0, "start", "include/model_deviation_start.stan");
    reader.add_event(439, 49, "end", "include/model_deviation_start.stan");
    reader.add_event(439, 59, "restart", "model_isotropic_vecchia");
    reader.add_event(450, 70, "include", "include/generated_quantities.stan");
    reader.add_event(450, 0, "start", "include/generated_quantities.stan");
    reader.add_event(454, 4, "end", "include/generated_quantities.stan");
    reader.add_event(454, 71, "restart", "model_isotropic_vecchia");
    reader.add_event(457, 72, "end", "model_isotropic_vecchia");
    return reader;
}
...
class model_isotropic_vecchia
  : public stan::model::model_base_crtp<model_isotropic_vecchia> {
private:
        int N;
        int D;
...
public:
    model_isotropic_vecchia(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_isotropic_vecchia_namespace::model_isotropic_vecchia";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_isotropic_vecchia_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
    ...
    std::string model_name() const {
        return "model_isotropic_vecchia";
    }
...
typedef model_isotropic_vecchia_namespace::model_isotropic_vecchia stan_model;
#ifndef USING_R
