...
#include "stanExports_anisotropic_vecchia.h"

RCPP_MODULE(stan_fit4anisotropic_vecchia_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("rstantools_model_anisotropic_vecchia")
